...
describe('[Challenge] Free Rider', function () {
    ...
    it('Execution', async function () {
        ...
        const attackerFactory = await ethers.getContractFactory('FreeRiderAttacker', player);
        const attacker = await attackerFactory.deploy(
            uniswapPair.address, weth.address, marketplace.address, devsContract.address,
            { value: PLAYER_INITIAL_ETH_BALANCE / 100n * 50n }
        );
