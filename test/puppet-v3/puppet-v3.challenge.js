...
describe('[Challenge] Puppet v3', function () {
    ...
    /** SET RPC URL HERE */
    const MAINNET_FORKING_URL = process.env.INFURA_URL;
    ...
    it('Execution', async function () {
        ...
        const attacker = await (await ethers.getContractFactory('AttackerPuppetV3', player)).deploy();
        token.connect(player).transfer(attacker.address, PLAYER_INITIAL_TOKEN_BALANCE);
    });
